...
# 支持的物品（Minecraft 1.14+）

## 原版 (Minecraft)

| 物品                | 支持的 Minecraft 版本 | 首次支持的模组版本  | 模组加载器            |
| ------------------- | ------------------------- | -------------------------- | --------------------- |
| Blaze Rod           | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Coal                | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Copper Ingot        | 1.17+                     | 0.1.0                      | Fabric,Forge,Neoforge |
| Diamond             | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Emerald             | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Ender Pearl         | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Gold Ingot          | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Iron Ingot          | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Lapis               | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Nether Quartz       | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Redstone            | 全部                       | 0.1.0                      | Fabric,Forge,Neoforge |
| Netherite Ingot     | 1.16+                     | 1.3.5                      | Fabric,Forge,Neoforge |
| Clay                | 全部                       | 1.6.0(Fabric) 1.2.0(Forge) | Fabric,Forge,Neoforge |
| Bone                | 全部                       | 1.7.3(Fabric) 1.3.3(Forge) | Fabric,Forge,Neoforge |
| Glowstone Dust      | 全部                       | 1.7.3(Fabric) 1.3.3(Forge) | Fabric,Forge,Neoforge |
| Nether Star         | 全部                       | 1.7.3(Fabric) 1.3.3(Forge) | Fabric,Forge,Neoforge |
| Slime Ball          | 全部                       | 1.7.3(Fabric) 1.3.3(Forge) | Fabric,Forge,Neoforge |
| White Wool          | 全部                       | 2.4.0                      | Fabric,Forge,Neoforge |
| Egg                 | 全部                       | 2.4.0                      | Fabric,Forge,Neoforge |
| Feather             | 全部                       | 2.4.0                      | Fabric,Forge,Neoforge |
| Gunpowder           | 全部                       | 3.1.0(3.X),2.7.0(2.X)      | Fabric,Forge,Neoforge |
| Leather             | 全部                       | 3.2.0(3.X),2.8.0(2.X)      | Fabric,Forge,Neoforge |
| Netherite Scrap     | 全部                       | 3.3.0(3.X),2.9.0(2.X)      | Fabric,Forge,Neoforge |
| Acacia Log          | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Amethyst Shard      | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Bamboo Block        | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Birch Log           | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Cherry Log          | 1.20+                     | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Crimson Stem        | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Dark Oak log        | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Jungle Log          | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Mangrove Log        | 1.19+                     | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Oak Log             | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Pale Oak Log        | 1.21.4+                   | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Spruce Log          | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Warped Stem         | 全部                       | 3.4.0(3.X),2.10.0(2.X)     | Fabric,Forge,Neoforge |
| Prismarine Shard    | 全部                       | 3.5.0(3.X),2.11.0(2.X)     | Fabric,Forge,Neoforge |
| Prismarine Crystals | 全部                       | 3.5.0(3.X),2.11.0(2.X)     | Fabric,Forge,Neoforge |
| Sand                | 全部                       | 3.6.0(3.X)                 | Fabric,Forge,Neoforge |
| String              | 全部                       | 3.6.0(3.X)                 | Fabric,Forge,Neoforge |
| Honeycomb           | 全部                       | 3.8.0(3.X)                 | Fabric,Forge,Neoforge |
| Echo Shard          | 全部                       | 3.8.0(3.X)                 | Fabric,Forge,Neoforge |
...
| 物品                  | 支持的 Minecraft 版本 | 首次支持的模组版本 | 模组加载器            |
| --------------------- | ------------------------- | ------------------------- | --------------------- |
| Certus Quartz Crystal | 全部                       | 0.1.0                     | Fabric,Forge,Neoforge |
| Fluix Crystal         | 全部                       | 2.0.0                     | Fabric,Forge,Neoforge |

## TechReborn!  

| 物品           | 支持的 Minecraft 版本 | 首次支持的模组版本 | 模组加载器                                                  |
| -------------- | ------------------------- | ------------------------- | ----------------------------------------------------------- |
| Aluminum Ingot | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Silver Ingot   | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Cinnabar Dust  | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Galena Dust    | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Iridium Ingot  | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| lead Ingot     | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Peridot Gem    | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Sulfur Dust    | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Ruby Gem       | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Sapphire Gem   | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Tungsten Ingot | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| SodaliteDust   | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Zinc Ingot     | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Tin Ingot      | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
| Tungsten Ingot | 全部                       | 0.1.0(Fabric)             | Fabric,Forge(Sinytra Connector),Neoforge(Sinytra Connector) |
...
| 物品             | 支持的 Minecraft 版本 | 首次支持的模组版本 | 模组加载器   |
| ---------------- | ------------------------- | ------------------------- | ------------ |
| Amber Gem        | 全部                       | 1.1.0(Fabric)             | Fabric,Forge |
| Thallasium Ingot | 全部                       | 1.1.0(Fabric)             | Fabric,Forge |
| Ender Dust       | 全部                       | 1.1.0(Fabric)             | Fabric,Forge |
